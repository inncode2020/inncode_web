    ...
    packages: [
      {
        ...
        features: [
          {
            isProvided: true,
            value: "Unmetered Bandwidth",
          },
          { isProvided: true, value: "Breadcrumbs" },
          { isProvided: true, value: "Data Transfer" },
          { isProvided: true, value: "Wireframes" },
          { isProvided: true, value: "Social Media Integration" },
          { isProvided: true, value: "SQL Database" },
          { isProvided: true, value: "Website Analytics" },
          { isProvided: true, value: "Up To 10 Pages" },
          { isProvided: false, value: "Free SSL Certificate" },
          { isProvided: true, value: "Search & SEO Analytics" },
          { isProvided: true, value: "2 months technical support" },
        ],
      },
      {
        price: "25k-50k",
        ...
        isFeatured: true,
        features: [
          { isProvided: true, value: "Unmetered Bandwidth" },
          { isProvided: true, value: "Breadcrumbs" },
          { isProvided: true, value: "Data Transfer" },
          { isProvided: true, value: "Wireframes" },
          { isProvided: true, value: "Social Media Integration" },
          { isProvided: true, value: "SQL Database" },
          { isProvided: true, value: "Website Analytics" },
          { isProvided: true, value: "Up To 25 Pages" },
          { isProvided: true, value: "Free SSL Certificate" },
          { isProvided: true, value: "Search & SEO Analytics" },
          { isProvided: true, value: "6 months technical support" },
        ],
      },
      {
        price: "50k or Above",
