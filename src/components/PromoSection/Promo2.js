  ...
  render() {
    return (
      <React.Fragment>
        <section
          className={
            "promo-section ptb-100 " +
            (this.props.removeTopMargin ? "" : "mt-5")
          }
        >
            ...
            <div className="row">
              <div className="col-lg-3 col-sm-6 mb-lg-0">
                <div className="card single-promo-card single-promo-hover">
                  <div className="card-body">
                    <div className="pb-2">
                      <span className="ti-credit-card icon-md color-secondary">
                        {" "}
                      </span>{" "}
                    </div>{" "}
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card single-promo-card single-promo-hover mb-lg-0">
                  <div className="card-body">
                    <div className="pb-2">
                      <span className="ti-control-record icon-md color-secondary">
                        {" "}
                      </span>{" "}
                    </div>{" "}
                    <div className="pt-2 pb-3">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card single-promo-card single-promo-hover mb-lg-0">
                  <div className="card-body">
                    <div className="pb-2">
                      <span className="ti-vector icon-md color-secondary">
                        {" "}
                      </span>{" "}
                    </div>{" "}
                    <div className="pt-2 pb-3">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card single-promo-card single-promo-hover mb-lg-0">
                  <div className="card-body">
                    <div className="pb-2">
                      <span className="ti-receipt icon-md color-secondary">
                        {" "}
                      </span>{" "}
                    </div>{" "}
                    <div className="pt-2 pb-3">
