...
const Pricing = ({ bgColor, showTitle, theme, hideFaq }) => (
  <React.Fragment>
    <div className="overflow-hidden">
      ...
      >
        <div className="container">
          ...
          <div className="row justify-content-center">
            {(_data.packages || []).map((_package, index) => {
              return (
                  ...
                  >
                    ...
                    <div className="card-body">
                      ...
                      <Link
                        ...
                        className={
                          "btn mb-3 " +
                          (_package.isFeatured ? "solid-btn" : "outline-btn")
                        }
                        target="_blank"
                      >
                        Purchase now
          ...
          {!(hideFaq && hideFaq === true) && theme !== "four" && (
