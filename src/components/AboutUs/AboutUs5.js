                ...
                <div className="about-content-left section-heading">
                  ...
                  <div className="single-feature mb-4">
                    <div className="d-flex align-items-center mb-2">
                      <span className="ti-vector rounded mr-3 icon icon-color-1">
                        {" "}
                      </span>{" "}
                  ...
                  <div className="single-feature mb-4">
                    <div className="d-flex align-items-center mb-2">
                      <span className="ti-dashboard rounded mr-3 icon icon-color-2">
                        {" "}
                      </span>{" "}
                    ...
                    <p>
                      ...
                      and revolutionary web services.Compellingly develop cross
                      -media.{" "}
                    </p>{" "}
                  </div>
                  <div className="single-feature mb-4">
                    <div className="d-flex align-items-center mb-2">
                      <span className="ti-alarm-clock rounded mr-3 icon icon-color-3">
                        {" "}
                      </span>{" "}
                      <h5 className="mb-0"> 24 / 7 Support </h5>{" "}
                    </div>{" "}
                    <p>
                      Phosfluorescently matrix enterprise-wide metrics vis-a
                      -vis extensive imperatives.Energistically empower best -
                      of -breed human{" "}
                    </p>{" "}
                  </div>{" "}
