          ...
          <div className="container">
            <div className="row align-items-center justify-content-center">
              <div className="col-md-9 col-lg-7">
                <div className="hero-content-left text-web-primary text-center">
                  <h1 className="text-web-primary"> Thank You! </h1>
                  <p className="lead">
                  ...
                  <div className="mb-5">
                    <h5 className="mb-0 text-web-primary">
                      {" "}
                      <span className="ti-mobile mr-2 align-items-center">
                        {" "}
                      </span>{" "}
                      (612) 255-461{" "}
                    </h5>{" "}
