                      ...
                      <div className="tab-pane" id="tab6-2">
                        <div className="single-feature">
                          <div className="d-flex align-items-center mb-2">
                            <span className="ti-layers rounded mr-3 icon icon-color-1">
                              {" "}
                            </span>{" "}
                          ...
                          <p>
                            ...
                            relationships whereas bleeding-edge
                            resources.Continually pontificate stand-alone
                            benefits whereas.{" "}
                          </p>{" "}
                        </div>{" "}
                        <div className="single-feature mb-4">
                          <div className="d-flex align-items-center mb-2">
                            <span className="ti-alarm-clock rounded mr-3 icon icon-color-2">
                              {" "}
                            </span>{" "}
                      ...
                      <div className="tab-pane" id="tab6-3">
                        <div className="row">
                          <div className="col single-feature mb-4">
                            <div className="d-flex align-items-center mb-2">
                              <span className="ti-bar-chart rounded mr-3 icon icon-color-2">
                                {" "}
                              </span>{" "}
                              <h5 className="mb-0"> Increase conversion </h5>{" "}
                            </div>{" "}
                          ...
                          <div className="col single-feature mb-4">
                            <div className="d-flex align-items-center mb-2">
                              <span className="ti-stats-up rounded mr-3 icon icon-color-3">
                                {" "}
                              </span>{" "}
